      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Chào mừng bạn trở lại! Sau đây là những thông tin mới nhất về cửa
            hàng của bạn hôm nay.
          </p>
        </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <Title>Dashboard</Title>
        <p className="text-gray-600 mt-2">
          Chào mừng bạn trở lại! Sau đây là những thông tin mới nhất về cửa hàng
          của bạn hôm nay.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard
          ...
          change={`${stats.ordersChangePct >= 0 ? "+" : ""}${
            stats.ordersChangePct
          }%`}
        ...
        <StatCard
          ...
          change={`${stats.usersChangePct >= 0 ? "+" : ""}${
            stats.usersChangePct
          }%`}
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button
            ...
            className="bg-white/20 backdrop-blur-sm hover:bg-white/30 transition-all duration-300 rounded-xl p-4 text-left"
          >
