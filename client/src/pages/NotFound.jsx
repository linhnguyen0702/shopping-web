        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-2">
              Trang bạn đang tìm kiếm có vẻ đã bị lạc.
            </p>
            <p className="text-gray-500">
              Đừng lo lắng, ngay cả những người khám phá tốt nhất cũng có lúc bị lạc!
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600">
                <strong>Bạn biết không?</strong> Trong khi bạn ở đây, hơn 1000
              khách hàng đang mua sắm trên trang web của chúng tôi!
            </p>
          </motion.div>
        </div>
      </Container>
